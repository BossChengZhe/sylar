...
static thread_local Fiber *t_scheduler_fiber = nullptr;                      // 当前线程执行协程
...
bool Scheduler::stopping() {
    ...
    bool temp = m_autoStop && m_stopping && m_fibers.empty() && m_activeThreadCount == 0;
    return temp;
}
...
void Scheduler::run(){
    ...
    } // 不相等时，在Scheduler::Scheduler函数中以及初始化
